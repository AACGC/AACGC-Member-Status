...
$eplug_tables = array(
"CREATE TABLE ".MPREFIX."aacgc_member_status(status_id int(11) NOT NULL auto_increment,status_user varchar(50) NOT NULL,status_text text NOT NULL,status_date int(10) unsigned NOT NULL,PRIMARY KEY  (status_id)) ENGINE=MyISAM;");
